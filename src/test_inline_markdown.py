...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_split_links(self):
        node = TextNode(
            "This is text with a [link1](https://www.google.com) and another [link2](https://www.youtube.com)",
            TextType.TEXT,
        )
    ...
    def test_split_without_image(self):
        ...
        new_nodes = split_nodes_image([node])
        self.assertListEqual([TextNode("This is a simple text", TextType.TEXT)], new_nodes)
